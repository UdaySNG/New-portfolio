...
const useFetchFeaturedProjects = () => {
  ...
  const fetchFeaturedProjects = async () => {
    ...
    try {
      ...
      // Filter featured projects from local data
      const localFeatured = (projectsData.data || []).filter(project => project.featured);
      setFeaturedProjects(localFeatured);
  ...
  return { featuredProjects, loading, isUsingFallback, error };
};
