...
const Loading = ({ text = 'Loading...', compact = false, error = null }) => {
        ...
        <div className="flex gap-2 p-4">
          {[0, 1, 2].map((index) => (
            <motion.div
              ...
              animate={{
                height: compact ? [48, 36, 48] : [64, 48, 64],
                y: compact ? [0, 6, 0] : [0, 8, 0],
                rotate: [0, 2, -2, 0],
              }}
              transition={{
                duration: 0.8,
        ...
        {[0, 1, 2].map((index) => (
          <motion.div
            ...
            animate={{
              height: compact ? [48, 36, 48] : [64, 48, 64],
              y: compact ? [0, 6, 0] : [0, 8, 0],
              scale: isLongLoading ? [1, 1.05, 1] : 1,
              rotate: isVeryLongLoading ? [0, 2, -2, 0] : 0,
            }}
            transition={{
              duration: isLongLoading ? 0.8 : 1,
              repeat: Infinity,
