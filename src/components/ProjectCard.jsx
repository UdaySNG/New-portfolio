...
const ProjectCard = ({ project }) => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      whileHover={{ y: -5 }}
      className={`group relative bg-white dark:bg-dark-lighter rounded-xl overflow-hidden shadow-xl hover:shadow-2xl hover:shadow-accent/20 transition-all duration-300 flex flex-col ${
        hasImage ? 'h-[500px]' : 'h-[400px]'
      }`}
    >
